                ...
                <div class="navbar">
                    <div class="container-xl">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item {{ request()->is('sms/send') ? 'active' : null }}">
                                <a class="nav-link" href="{{ route('sms.send') }}">
                                    <span
                                        class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                            ...
                            <li
                                class="nav-item dropdown {{ request()->is('support*', 'categories*', 'units*') ? 'active' : null }}">
                        ...
                        <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                            <ul class="list-inline list-inline-dots mb-0">
                                <li class="list-inline-item">
                                    ...
                                    <a href="." class="link-secondary">ProtoType🚀</a>
                                </li>
                                <!-- <li class="list-inline-item"> -->
